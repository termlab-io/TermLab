...
/**
 * No-op stub registered with {@code id="Debug"} in the Conch core plugin.xml
 ...
 * Conch's stripped module set (via {@code essential.minimal}) excludes the
 ...
 * anything — Conch has no real debugger.
 */
public final class NoopExecutorStubAction extends AnAction {

    @Override
    public void update(@NotNull AnActionEvent e) {
        // Hide and disable — Conch has no debugger, so don't pretend otherwise.
