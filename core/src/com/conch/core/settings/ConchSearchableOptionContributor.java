...
/**
 * Runtime searchable-options contributor for Conch settings.
 * Index terms are auto-discovered from the actual UI labels/components,
 * so settings search stays in sync as pages evolve.
 */
public final class ConchSearchableOptionContributor extends SearchableOptionContributor {

    @Override
    public void processOptions(@NotNull SearchableOptionProcessor processor) {
        contributeConfigurable(processor, new ConchTerminalConfigurable(), "Conch Terminal");
        contributeConfigurable(processor, new ConchTerminalAppearanceConfigurable(), "Conch Terminal");
        contributeConfigurable(processor, new ConchTerminalTerminalConfigurable(), "Conch Terminal");
    }
