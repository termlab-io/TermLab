...
public final class ConchTerminalAppearanceConfigurable implements SearchableConfigurable {

    public static final String ID = "conch.terminal.settings.appearance";
