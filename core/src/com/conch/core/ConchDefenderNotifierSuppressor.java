 ...
 * and never runs.
 *
 * <p>Conch does no project indexing — there is nothing to accelerate
 ...
 */
public final class ConchDefenderNotifierSuppressor implements AppLifecycleListener {

    private static final Logger LOG = Logger.getInstance(ConchDefenderNotifierSuppressor.class);
        ...
        try {
            ...
            if (value.asBoolean()) {
                ...
                if (SystemInfo.isWindows) {
                    LOG.info("Conch: disabled Windows Defender rules check ("
                        + REGISTRY_KEY + "=false)");
                }
            }
        } catch (Throwable t) {
            ...
            LOG.info("Conch: could not toggle " + REGISTRY_KEY
