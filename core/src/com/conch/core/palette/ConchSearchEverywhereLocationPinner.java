 ...
 * upper-half-center of the Conch frame every time the user invokes a
 ...
 * after moving the Conch window currently doesn't render the popup
 * (second press works). This is NOT caused by this listener — verified
 * by running Conch with zero SE customizations — and predates this
