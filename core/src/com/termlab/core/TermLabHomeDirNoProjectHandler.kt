 ...
 * directory as the default TermLab workspace. Registered via the
 ...
 *
 * TermLab is a terminal workstation: there is no "project" to pick in any
 ...
 */
internal class TermLabHomeDirNoProjectHandler : NoProjectStateHandler {
  override fun createHandler(): (suspend () -> Project?) = {
    val home = Path.of(System.getProperty("user.home"))
    LOG.info("TermLab: opening default workspace at $home")
    ProjectUtil.openOrImportAsync(home, OpenProjectTask())
  }

  private companion object {
    private val LOG = logger<TermLabHomeDirNoProjectHandler>()
  }
}
