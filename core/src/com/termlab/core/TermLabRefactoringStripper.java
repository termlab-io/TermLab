 ...
 *
 * <p>TermLab isn't an IDE — it's a terminal workstation — and the platform's
 ...
 * {@link TermLabToolWindowCustomizer} takes for unwanted tool windows.
 *
 ...
 */
public final class TermLabRefactoringStripper implements AppLifecycleListener {

    private static final Logger LOG = Logger.getInstance(TermLabRefactoringStripper.class);
    ...
    public void appFrameCreated(@NotNull List<String> commandLineArgs) {
        ...
        for (String id : UNWANTED_ACTION_IDS) {
            ...
            removed++;
            LOG.info("TermLab: unregistered refactoring action '" + id + "'");
        }
        LOG.info("TermLab: stripped " + removed + " refactoring action(s) / group(s)");
    }
}
