...
public final class TermLabThemeSyncCustomizer implements AppLifecycleListener {
    ...
    private static final Logger LOG = Logger.getInstance(TermLabThemeSyncCustomizer.class);
    ...
    public void appFrameCreated(@NotNull List<String> commandLineArgs) {
        try {
            ...
            if (light == null || dark == null) {
                LOG.warn("TermLab: could not find TermLab themes in installed LAF list");
                return;
            }
            ...
            LOG.warn("TermLab: failed to configure theme sync preferences", t);
        }
    }
    ...
    private static void removeBuiltinLookAndFeels(Object lafManager, List<Object> installed) {
        ...
        if (setInstalledLookAndFeels(lafManager, filtered)) {
            LOG.info("TermLab: removed built-in IntelliJ Light / Darcula themes from installed LAFs");
            return;
        }
        ...
        try {
            ...
            LOG.info("TermLab: removed built-in IntelliJ Light / Darcula themes via mutable iterable fallback");
    ...
    private static void pruneBuiltinFromLafManagerState(Object lafManager) {
        ...
        if (removed > 0) {
            LOG.info("TermLab: pruned " + removed + " built-in LAF entries from LafManager state");
            notifyLafListOrStateChanged(lafManager);
        }
    }
    ...
    private static void setPreferredThemeTargets(Object lafManager, Object light, Object dark) {
        ...
        for (Method method : methods) {
            ...
            try {
                ...
                LOG.warn("TermLab: could not invoke " + method.getName(), t);
            }
        }
    }
