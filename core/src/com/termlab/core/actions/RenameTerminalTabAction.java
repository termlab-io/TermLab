...
/**
 * Renames a TermLab terminal tab. Shown in the editor tab context menu
 ...
 *
 * <p>Renaming sets {@link TermLabTerminalVirtualFile#setManualTitleOverride(boolean)}
...
public final class RenameTerminalTabAction extends AnAction {
    ...
    private static @Nullable TermLabTerminalVirtualFile resolveTerminalFile(@NotNull AnActionEvent e) {
        ...
        if (files.length > 0 && files[0] instanceof TermLabTerminalVirtualFile term) {
            return term;
        }
