...
public final class TermLabActionConfigurationCustomizer implements ActionConfigurationCustomizer {
    ...
    private static final String[] IDE_CENTRIC_ACTION_IDS = {
        ...
        "XDebugger.PauseWatch",
        "XDebugger.ToggleEvaluateExpressionField",
        "XDebugger.RemoveAllWatches",
        "XDebugger.MuteBreakpoints",
        "XDebugger.RemoveAllButThisBreakpoint",
        "XDebugger.DisableAllButThisBreakpoint",
    ...
    private static final String[] IDE_CENTRIC_GROUP_IDS = {
        ...
        "ToolbarPopupActions.XDebugger.ToolWindow.TopToolbar3",
        "DebugToolbarQuickActions",
        "Bookmarks",
        "Bookmarks.Goto",
        "Bookmarks.Toggle",
