 ...
 * {@code ~/.config/conch/vault.enc}, a Dropbox/iCloud folder for sync, or a
 * USB key.
 *
 * <p>Non-path vault tuning (auto-lock minutes, push-to-system-agent, etc.)
 * lives inside each vault's {@link com.conch.vault.model.VaultSettings}, not
 ...
 */
public final class ConchVaultConfigurable implements SearchableConfigurable {

    public static final String ID = "conch.vault.settings";
    ...
    public boolean isModified() {
        String configured = ConchVaultConfig.getInstance().getState().vaultFilePath;
