 ...
 * the full {@code com.conch.vault} test tree via the JUnit 5 platform
 * launcher and prints a human-readable summary.
 *
 * <p>Usage:
 * <pre>
 *   bash bazel.cmd run //conch/plugins/vault:vault_test_runner
 * </pre>
 *
...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
            .selectors(DiscoverySelectors.selectPackage("com.conch.vault"))
            .build();
