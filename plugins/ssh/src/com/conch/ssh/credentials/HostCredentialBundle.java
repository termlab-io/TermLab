 ...
 * credential needed to open a session against a Conch {@link SshHost}.
 *
 ...
 * {@link ConchSshClient#connect} can still dispose of any sensitive
 * material.
 */
public record HostCredentialBundle(
     ...
     * retry without re-dispatching on {@link com.conch.ssh.model.SshAuth}.
     *
    ...
    public static @Nullable HostCredentialBundle resolveForHost(@NotNull SshHost host) {
        ...
        ConchSshClient.BastionAuth bastion = null;
     ...
     */
    public static @Nullable ConchSshClient.BastionAuth resolveBastionFor(@NotNull SshHost target) {
        ...
        return new ConchSshClient.BastionAuth(stored.host(), stored.port(), bastionCred);
    }
