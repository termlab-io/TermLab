 ...
 * {@code com.conch.ssh} test tree via the JUnit 5 platform launcher and
 ...
 * <p>Usage:
 * <pre>
 *   bash bazel.cmd run //conch/plugins/ssh:ssh_test_runner
 * </pre>
 */
public final class TestRunner {
    ...
    public static void main(String[] args) {
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
            .selectors(DiscoverySelectors.selectPackage("com.conch.ssh"))
            .build();
