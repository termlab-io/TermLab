package com.termlab.tunnels.palette;

import com.termlab.tunnels.model.SshTunnel;
import com.termlab.tunnels.model.TunnelStore;
import com.termlab.tunnels.toolwindow.TunnelCellRenderer;
...
/**
 * Exposes saved {@link SshTunnel} entries in the TermLab command palette
...
public final class TunnelsSearchEverywhereContributor implements SearchEverywhereContributor<SshTunnel> {
    ...
    @Override public @NotNull String getSearchProviderId() { return "TermLabTunnels"; }
    ...
    public @Nullable Object getDataForItem(@NotNull SshTunnel element, @NotNull String dataId) {
        return Objects.equals(dataId, "com.termlab.tunnels.tunnel") ? element : null;
    }
